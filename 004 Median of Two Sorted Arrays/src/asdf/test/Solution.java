...
public class Solution {
	...
	// 查找两个数组中某个位置上的数
	public double findNumberSortedArrays(int[] nums1, int[] nums2, int pos) {
...
//		System.out.println(localpos1);
//		System.out.println(localpos2);
...
//		System.out.println(pos);
	...
	public double findMedianSortedArrays(int[] nums1, int[] nums2) {
		...
		if (allLength % 2 == 1) {
			return findNumberSortedArrays(nums1, nums2, allLength / 2);
		} else {
			allLength = allLength / 2;
			return (findNumberSortedArrays(nums1, nums2, allLength - 1) + findNumberSortedArrays(
					nums1, nums2, allLength)) / 2;
		}
...
//		System.out.println(solution.findNumberSortedArrays(c, c, i));
		 ...
		 System.out.println(solution.findMedianSortedArrays(b, a));
